...
struct TREE
{
	...
	TREE(int Freq, char Let, TREE *Left, TREE *Right) : freq(Freq), let(Let), left(Left), right(Right) { }
...
void AddLetter(Letter **L, int freq, char let)
{
